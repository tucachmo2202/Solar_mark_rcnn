"""
Mask R-CNN
Train on the toy Solar dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 solar.py train --dataset=/path/to/solar/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 solar.py train --dataset=/path/to/solar/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 solar.py train --dataset=/path/to/solar/dataset --weights=imagenet

    # Apply color splash to an image
    python3 solar.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 solar.py splash --weights=last --video=<URL or path to file>
"""
...
ROOT_DIR = os.getcwd()
if ROOT_DIR.endswith("samples/solar"):
...
class SolarDataset(utils.Dataset):
    ...
    def load_solar(self, dataset_dir, subset):
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect solars.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/solar/dataset/",
                        help='Directory of the Solar dataset')
